...
final class FireBaseManager {
    ...
    private init() {
        ...
        self.databaseRef = Database.database(url: "https://volcado-echo-ios-default-rtdb.europe-west1.firebasedatabase.app").reference()
    ...
    func fetchTopRatesURL() async throws -> String {
        let ref = databaseRef.child("active-volcanos")
